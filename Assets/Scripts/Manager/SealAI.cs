...
public class SealAI : MonoBehaviour
{
    ...
    [SerializeField] private float velocidadHuida = 4.6f;
    [SerializeField] private float velocidadCaza = 3.8f;
    [SerializeField] private float limiteInferiorY = -12f;
    [SerializeField] private float nivelAgua = 8f;
    [SerializeField] private float margenSuperficie = 0.6f;

    [Header("Inteligencia")]
    [SerializeField] private float distanciaDeteccionJugador = 4.5f;
    [SerializeField] private float distanciaBuscarPeces = 4f;
    [SerializeField] private float distanciaComerPez = 0.8f;
    [SerializeField] private float tiempoCambioDireccion = 2.5f;

    [Header("Salto")]
    [SerializeField] private float probabilidadSalto = 0.1f;
    [SerializeField] private float intervaloIntentoSalto = 6f;
    [SerializeField] private float alturaSalto = 2f;
    [SerializeField] private float duracionSalto = 1.4f;

    [Header("Animacion")]
    [SerializeField] private float velocidadAnimacion = 0.15f;
    ...
    private void ElegirDireccionAleatoria()
    {
        ...
        if (Mathf.Abs(direccion.x) < 0.45f)
        {
            direccion.x =
                Random.value < 0.5f
                    ? -0.45f
